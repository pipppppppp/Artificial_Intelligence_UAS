...
<div class="panel panel-default">
    <div class="panel-heading">        
        <form class="form-inline">
            ...
            <div class="form-group">
                <a class="btn btn-primary" href="?m=gejala_tambah"><span class="glyphicon glyphicon-plus"></span> AddNew Gejala</a>
            </div>
        </form>
    </div>
    <div class="table-responsive">
        ...
        <tr>
            ...
            <td class="nw">
                ...
                <a class="btn btn-xs btn-danger" href="aksilog.php?act=gejala_hapus&ID=<?=$row->kode_gejala?>" onclick="return confirm('Hapus data?')"><span class="glyphicon glyphicon-trash"></span></a>
            </td>
        </tr>
        <?php endforeach;?>
        </table>
